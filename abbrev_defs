...
(define-abbrev-table 'eshell-mode-abbrev-table
  '(
    ...
    ("btkah1" "bq query --project_id=broadie-sbx-tkahura-edm-01" nil :count 42)
    ("bkota1" "bq query --project_id=broadie-sbx-tkota-edm-01" nil :count 41)
    ("bkota2" "bq query --project_id=broadie-sbx-tkota-edm-02" nil :count 41)
    ("bdkam1" "bq query --project_id=broadie-sbx-dkamuten-edm-01" nil :count 41)
    ("bscho1" "bq query --project_id=broadie-sbx-schoudha-edm-01" nil :count 40)
    ...
    ("btapu" "bq query --project_id=broad-bits-tapestry-int" nil :count 31)
    ("btaph" "bq query --project_id=broad-bits-tapestry-hotfix-02" nil :count 35)
    ("btapprod" "bq query --project_id=broad-bits-tapestry-prod" nil :count 30)
    ...
    ("drkgra1" "dbt run --target=kgraham1 --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.*" nil :count 30)
    ("drkgra2" "dbt run --target=kgraham2 --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.*" nil :count 30)
    ("drkota1" "dbt run --target=kota1 --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.*" nil :count 29)
    ("drkota2" "dbt run --target=kota2 --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.*" nil :count 29)
    ("drtkah1" "dbt run --target=tkahura1 --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.*" nil :count 31)
    ("drdkam1" "dbt run --target=dkamuten1 --profiles-dir ../DOCS/.dbt/sbxs --select  +reporting.finance.*" nil :count 0)
