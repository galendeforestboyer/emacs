...
(define-abbrev-table 'eshell-mode-abbrev-table
  '(
    ...
    ("drkota1" "dbt run --target=kota1 --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 29)
    ("drkota2" "dbt run --target=kota2 --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 29)
    ("drtkah1" "dbt run --target=tkahura1 --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 31)
    ("drdkam1" "dbt run --target=dkamuten1 --profiles-dir ../DOCS/.dbt --select " nil :count 0)
