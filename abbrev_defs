...
(define-abbrev-table 'eshell-mode-abbrev-table
  '(
    ...
    ("btapu" "bq query --project_id=broad-bits-tapestry-uat" nil :count 31)
    ...
    ("drtapd" "dbt run --target=tapd  --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 48)
    ("drtapi" "dbt run --target=int  --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 48)
    ("drtapu" "dbt run --target=uat  --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 48)
    ("drtaph" "dbt run --target=hotfix  --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 48)
    ("drtapp" "dbt run --target=tapp  --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 48)
