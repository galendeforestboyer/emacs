...
(define-abbrev-table 'global-abbrev-table
  '(
    ("pg1" "broadie-sbx-gboyer-edm-01" nil :count 99)
    ("pg2" "broadie-sbx-gboyer-edm-02" nil :count 78)
    ("pg3" "broadie-sbx-gboyer-edm-03" nil :count 73)
    ("pgc1" "broadie-sbx-gboyer-comptest" nil :count 70)
    ("pgc2" "broadie-sbx-gboyer-comptest2" nil :count 65)
    ("pkgra1" "broadie-sbx-kgraham-edm-01" nil :count 41)
    ("pkgra2" "broadie-sbx-kgraham-edm-02" nil :count 41)
    ("ptkah1" "broadie-sbx-tkahura-edm-01" nil :count 42)
    ("pkota1" "broadie-sbx-tkota-edm-01" nil :count 41)
    ("pkota2" "broadie-sbx-tkota-edm-02" nil :count 41)
    ("pdkam1" "broadie-sbx-dkamuten-edm-01" nil :count 41)
    ("pscho1" "broadie-sbx-schoudha-edm-01" nil :count 40)
    ))

(define-abbrev-table 'eshell-mode-abbrev-table
  '(
    ("bg1" "bq query --project_id=broadie-sbx-gboyer-edm-01" nil :count 99)
    ...
    ("bkg1" "bq query --project_id=broadie-sbx-kgraham-edm-01" nil :count 41)
    ("bkg2" "bq query --project_id=broadie-sbx-kgraham-edm-02" nil :count 41)
    ("btk1" "bq query --project_id=broadie-sbx-tkahura-edm-01" nil :count 42)
    ("bko1" "bq query --project_id=broadie-sbx-tkota-edm-01" nil :count 41)
    ("bko2" "bq query --project_id=broadie-sbx-tkota-edm-02" nil :count 41)
    ("bdk1" "bq query --project_id=broadie-sbx-dkamuten-edm-01" nil :count 41)
    ("bsc1" "bq query --project_id=broadie-sbx-schoudha-edm-01" nil :count 40)
    ("btd" "bq query --project_id=broad-bits-tapestry-dev" nil :count 30)
    ("bti" "bq query --project_id=broad-bits-tapestry-int" nil :count 31)
    ("btu" "bq query --project_id=broad-bits-tapestry-uat" nil :count 31)
    ("bth" "bq query --project_id=broad-bits-tapestry-hotfix-02" nil :count 35)
    ("btp" "bq query --project_id=broad-bits-tapestry-prod" nil :count 30)
    ...
    ("drtd" "dbt run --target=tapd  --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 48)
    ("drti" "dbt run --target=int  --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 48)
    ("drtu" "dbt run --target=uat  --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 48)
    ("drth" "dbt run --target=hotfix  --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 48)
    ("drtp" "dbt run --target=tapp  --profiles-dir ../DOCS/.dbt --select +reporting.finance.*" nil :count 48)
    ("drg1" "dbt run --target=gboyer1  --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.* --exclude reporting.finance.prms.*" nil :count 48)
    ...
    ("drgc1" "dbt run --target=gboyerc1  --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.* --exclude reporting.finance.prms.*" nil :count 39)
    ("drgc2" "dbt run --target=gboyerc2  --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.* --exclude reporting.finance.prms.*" nil :count 39)
    ("drkg1" "dbt run --target=kgraham1 --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.*" nil :count 30)
    ("drkg2" "dbt run --target=kgraham2 --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.*" nil :count 30)
    ("drko1" "dbt run --target=kota1 --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.*" nil :count 29)
    ("drko2" "dbt run --target=kota2 --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.*" nil :count 29)
    ("drtk1" "dbt run --target=tkahura1 --profiles-dir ../DOCS/.dbt/sbxs --select +reporting.finance.*" nil :count 31)
    ("drdk1" "dbt run --target=dkamuten1 --profiles-dir ../DOCS/.dbt/sbxs --select  +reporting.finance.*" nil :count 0)
    ...
    ("pdk1" "--project_id=broadie-sbx-dkamuten-edm-01" nil :count 40)
    ("pkg1" "--project_id=broadie-sbx-kgraham-edm-01" nil :count 40)
    ("pkg2" "--project_id=broadie-sbx-kgraham-edm-02" nil :count 40)
    ("poihd" "--project_id=broad-bits-tapestry-oih-dev" nil :count 10)
    ("poihp" "--project_id=broad-bits-tapestry-oih-prod" nil :count 11)
    ("psc1" "--project_id=broadie-sbx-schoudha-edm-01" nil :count 40)
    ("ptd" "--project_id=broad-bits-tapestry-dev" nil :count 23)
