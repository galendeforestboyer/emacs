...
(define-abbrev-table 'eshell-mode-abbrev-table
  '(
    ...
    ("pgboy1" "--project_id=broadie-sbx-gboyer-edm-01" nil :count 48)
    ("pgboy2" "--project_id=broadie-sbx-gboyer-edm-02" nil :count 48)
    ("pgboy3" "--project_id=broadie-sbx-gboyer-edm-03" nil :count 49)
